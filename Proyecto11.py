...
CODIGO DE MEDIDOR (PLAZA ESPAÑA, CUATRO CAMINOS O VALLECAS VILLA)
CODIGO DE MAGNITUD Y DE TECNICA DE MEDIA
04 QUE INDICA QUE SON DATOS DIARIOS
AAMM(DESDE ENERO HASTA OCTUBRE, QUE SON LOS DATOS QUE TENEMOS)
NUMERICO DE 5 DIGITOS Y CODIGO VALIDACION (SI ES V OK, SI ES N NO ES VALIDO -> NO CONTARLO)
CADA GRUPO NUMERICO+CODIGO VALIDACION REPRESENTA CADA DIA DEL MES
